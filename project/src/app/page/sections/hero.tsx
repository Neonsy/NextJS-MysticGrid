...
export default function Hero() {
    return (
        <section className='flex flex-col items-center justify-center bg-slate-950/75 px-8 py-16'>
            <h1 className='from-gradient-logo-start via-gradient-logo-middle to-gradient-logo-end bg-gradient-to-r bg-clip-text text-4xl font-bold text-transparent'>
                Welcome to MysticGrid
            </h1>
