...
export default function Hero() {
    return (
        <section className='flex flex-col items-center justify-center bg-slate-950/75 px-4 py-12 sm:px-8 sm:py-16'>
            ...
            <Link
                href='/play'
                className='mt-8 inline-block rounded-lg border border-white/20 bg-slate-900/40 p-3 text-base font-semibold text-white/90 shadow-[0_4px_12px_rgba(255,255,255,0.08)] backdrop-blur-sm transition-all duration-300 hover:translate-y-[-2px] hover:border-white/30 hover:bg-slate-800/40 hover:shadow-[0_8px_24px_rgba(255,255,255,0.12)] focus:outline-none focus:ring-2 focus:ring-white/30 focus:ring-offset-2 focus:ring-offset-slate-950 active:translate-y-[1px] sm:text-lg'>
                Begin Your Quest
            </Link>
        </section>
    );
