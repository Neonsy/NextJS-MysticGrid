...
export default function FeatureCard({ title, description, icon: Icon, variant }: FeatureCardProps) {
    ...
    return (
        <div className='rounded-lg ~mb-4/8 bg-slate-800 bg-opacity-10 backdrop-blur-sm transition-all ~p-4/8 hover:bg-opacity-20'>
            <div>
                ...
                <p className='text-slate-400 max-w-[75%] lg:max-w-full ~text-base/lg'>{description}</p>
            </div>
        </div>
    );
}
